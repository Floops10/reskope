...
const CONTENT = {
  fr: {
    ...
    billing: {
      ...
      text: 'Un jour d’intervention = 450 €. L’audit et l’abonnement sont à prix fixe ; l’audit est intégralement déduit si vous me confiez la mise en œuvre. La réalisation dépend du temps passé et de la complexité, estimée et validée avec vous avant de démarrer. Aucune surprise sur la facture.',
  ...
  en: {
    ...
    lead: 'Every engagement is different, but pricing is clear from the start. We define the scope together, and you know what you pay, and why. The audit rates below are launch rates, reserved for the first 3 companies and valid until 31 December 2026.',
    ...
    hideLabel: 'Hide',
    prices: {
      audit: { amount: 'from €990', note: 'Fixed package by headcount: €990 (≤10 people) · €1,490 (10-30) · €2,400 (30-80)', type: 'Launch rate' },
      'audit-plus': { amount: '€450/day', note: 'Audit included and fully deducted, delivery estimated upfront', type: 'Time-based' },
      developpement: { amount: 'from €1,200', note: 'Automation from €1,200 · website from €1,900 · internal tool from €3,500', type: 'By complexity' },
      suivi: { amount: 'from €290/month', note: '½ day €290 · 1 day €490 · 2 days €890', type: 'Subscription' },
    },
    billing: {
      kicker: 'Transparency',
      title: 'How I bill.',
